...
Ключевые драйверы числа заказов — метрики: user_id, is_two, is_five полностью определяются количеством покупок (корреляция 1.00). Поведенческий индикатор — total_tickets: его высокая корреляция (0.88) говорит, что частота покупок связана с ростом среднего чека.
